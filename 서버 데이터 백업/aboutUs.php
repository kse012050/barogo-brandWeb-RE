        ...
        <main data-scroll="area" class="">
            <div data-scroll="area" class="b">
                <div data-scroll="area" class="a active">
                    ...
                    <p class="metaArea">
                        <span>META LOGISTIS UNIVERSE</span>
                    </p>
                ...
                <section class="numberArea" data-specialAni="graph" data-eventAni="count">
                    <div class="CW">
                        ...
                        <div class="countArea">
                            <div class="graphArea">
                                <mark id="percent" data-eventAni="target" data-startCount="0" data-endCount="1893">0</mark>
                            ...
                            <ol data-scroll="target">
                                <li class="active">
                                    ...
                                    <ol>
                                        ...
                                        <li title="2021.06">시리즈 C 투자</li>
                                        <li title="2020.10">
                                            <mark>도시주방</mark> 1호점 오픈<small>바로고의 공유주방 브랜드</small>
                                            <div class="imgArea">
                                ...
                                <li>
                                    ...
                                    <ol>
                                        ...
                                        <li title="2019.09">모빌리티 플랫폼 <mark>무빙</mark> 설립<small>50/50 JV</small></li>
                                        <li title="2019.06">시리즈 B투자 & 시리즈 B+투자</li>
                                        <li title="2019.04">바로고앤 설립</li>
                                        <li title="2018.05">시리즈 A 투자</li>
                                    </ol>
                                </li>
                                <li>
            ...
            <section class="breandArea">
                <div class="CW">
                    ...
                    <ul class="logoArea">
                        ...
                        <li>
                            <b>Vertical A</b>
                            <img src="images/aboutUs/logoSystem02.png" alt="Vertical A">
                        </li>
                        <li>
                            <b>Vertical B</b>
                            <img src="images/aboutUs/logoSystem03.png" alt="Vertical B">
                        </li>
                    </ul>
