        ...
        <main data-scroll="area" class="">
            <div data-scroll="area">
                <div data-scroll="area" class="active">
                    ...
                    <section class="toDoArea" data-scrollAni="move">
                        <div class="CW">
                            <div class="titleArea">
                                ...
                                <ul data-scroll="target" class="scrollSlider">
                                    ...
                                    <li>
                                        <div class="textArea">
                                            ...
                                            <a href="http://www.dosikitchen.co.kr" title="도시주방 홈페이지" target="_blank" class="BBTN-go">자세히 보기</a>
                                        </div>
                                        <div class="imgArea">
                                    ...
                                    <li>
                                        ...
                                        <div class="imgArea">
                                            <img src="https://barogo-homepage.s3.ap-northeast-2.amazonaws.com/toDo04.png" alt="올스타포스 이미지">
                                        </div>
                                    </li>
                                </ul>
                            </div>
                ...
                <section class="numberArea" data-specialAni="graph" data-eventAni="count">
                    <div class="CW">
                        ...
                        <div class="countArea">
                            ...
                            <div class="yearArea">
                                <h3 id="year" data-eventAni="target" data-startCount="2016" data-endCount="2023">2016</h3>
                                <ul>
                                    <li title="허브 수">
                        ...
                        <div class="monthArea">
                            <ol class="overLine-right" data-scroll="target">
                                <li>
                                    ...
                                    <ol>
                                        <li title="2015.02">바로고의 시작</li>
                                        <li title="2015.08">B2B 첫 계약</li>
                                        <li title="2016.08">월 배송 건수 100만 건 돌파</li>
                                    </ol>
                                </li>
                                <li>
                                    <strong>2018 - 2019</strong>
                                    <ol>
                                        <li title="2018.04">시리즈 A 투자 (200억원)</li>
                                        <!-- <li title="2019.04">바로고앤 설립</li> -->
                                        <li title="2019.09">누적 배달 건수 1억건 돌파</li>
                                        <li title="2019.09">모빌리티 플랫폼 무빙(50/50 JV) 설립</li>
                                        <li title="2019.12">시리즈 B & B+ 투자 (200억원)</li>
                                    </ol>
                                </li>
                                <li class="active">
                                    <strong>2020 - 현재</strong>
                                    <ol>
                                        <li title="2020.05">배달대행 플랫폼 '모아라인(모아콜)' 인수</li>
                                        <li title="2020.10">
                                        ...
                                        <!-- <li title="2021.07">월 배달 건수 1,893만 건 돌파</li> -->
                                        <li title="2022.01">시리즈 C & C+ 투자 (1,500억원)</li>
                                        <li title="2023.02">배달대행 플랫폼 '딜버' 인수</li>
                                        <li title="2023.07">월 배달 건수 2,120만 건 돌파</li>
                                        <li title="2023.10">종합 포스(POS) 시장 진출 '올스타포스' 론칭</li>
                                    </ol>
                                </li>
                            </ol>
                        </div>
            ...
            <section class="breandArea">
                <div class="CW">
                    ...
                    <a <?=homepageLinkCheck(getValue($content,"file1"))?> title="바로고 BI, 가이드 다운로드" class="BBTN-download">BI / GUIDE</a>
                </div>
            </section>
