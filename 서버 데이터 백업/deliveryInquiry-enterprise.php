            ...
            <form id="inquiryForm" onsubmit="return false">
                ...
                <fieldset class="inquiryArea">
                    ...
                    <ul class="overLine-right inputArea">
                        <li>
                            <label for="">성함/직급</label>
                            <input type="text" placeholder="성함/직급" name="name" autocomplete="off">
                        </li>
                        <li>
                            <label for="">연락처</label>
                            <div>
                                ...
                                <input class="digit_number" type="text"  name="mobile2" autocomplete="off" maxlength="4">
                                <input class="digit_number" type="text"  name="mobile3" autocomplete="off" maxlength="4">
                            </div>
                        </li>
                        <li>
                            <label for="">매장 위치</label>
                            <input type="text" placeholder="매장위치입력" name="address_detail" autocomplete="off">
                        </li>
                        <li>
                            <label for="">법인명(브랜드명)</label>
                            <input type="text" placeholder="법인명(브랜드명)" name="brand_name" autocomplete="off">
                        </li>
                        <li>
                            <label for="">희망 배달 품목</label>
                            <input type="text" placeholder="배달품목" name="hope_delivery_item" autocomplete="off">
                        </li>
                        <li>
                            <label for="">희망 배달 지역</label>
                            <input type="text" placeholder="ex. 강남구, 서초구 일대 / 부산 / 전국구 등" name="hope_delivery_location" autocomplete="off">
                        </li>
                        <li>
                            <label for="">이메일</label>
                        ...
                        <li>
                            <label for="">문의 사항 (300자 이내)</label>
                            <textarea placeholder="자유롭게 문의 사항을 남겨 주세요" name="comment" maxlength="300"></textarea>
                        </li>
                    </ul>
                </fieldset>
