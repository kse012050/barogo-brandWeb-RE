                ...
                <fieldset class="inquiryArea">
                    ...
                    <ul class="overLine-right inputArea">
                        <li class="required">
                            ...
                            <input class="basic_input" type="text" placeholder="매장명" name="shop_name" autocomplete="off" id="storeName">
                        </li>
                        <li class="required">
                        ...
                        <li class="required">
                            ...
                            <input class="basic_input" type="text" placeholder="상세 주소 입력" name="address_detail" autocomplete="off">
                        </li>
                        <li class="required">
                        ...
                        <li class="required">
                            ...
                            <div>
                                ...
                                <input type="text" value="" name="mobile2" id="mobile2" class="digit_number"  maxlength="4" autocomplete="off">
                                <input type="text" value="" name="mobile3" id="mobile3" class="digit_number"  maxlength="4" autocomplete="off">
                            </div>
                        </li>
                        <li class="required">
                            <label for="userEmail">이메일</label>
                            <input class="email_form" type="email" placeholder="welcome@barogo.com" name="email" autocomplete="off" id="userEmail">
                            <p class="">이메일 형식에 맞게 입력해 주세요.</p>
                        </li>
                    </ul>
                </fieldset>
                        ...
                        <li>
                            ...
                            <div class="popupBox" data-popup="popup04">
                                <div>
                                    ...
                                    <div class="btnArea">
                                        <button data-chk="letter_subscription_yn">받아보기</button>
<!--                                        <a href="" data-chk="letter_subscription_yn">받아보기</a>-->
                                    </div>
                                </div>
                            </div>
                        </li>
