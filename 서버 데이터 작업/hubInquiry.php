                ...
                <fieldset class="inquiryArea">
                    ...
                    <ul class="overLine-right inputArea">
                        ...
                        <li class="required current-option">
                            ...
                            <input class="basic_input" type="text" placeholder="ex. 바로고 프로그램" name="current_use_program"  id="current_use_program" autocomplete="off">
                        </li>
                        <li class="required current-option">
                        ...
                        <li>
                            ...
                            <input class="basic_input" type="text" placeholder="ex. 운영기간, 권역 범위 등" name="comment" id="comment" autocomplete="off">
                        </li>
                    </ul>
                </fieldset>
